...
border:1px solid black;
  ...
  <title>Signed Out Students Information</title>
  <meta charset="utf-8">
...
$sql = "SELECT roll_no,place,in_time,out_time FROM st_status ";
$result = $conn->query($sql);

$sql1 = "SELECT name,room_no,block_no,phone_no,home_addr,parent_no FROM student ";
